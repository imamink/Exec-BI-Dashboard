...
An end-to-end business intelligence project analyzing 4 years of U.S. retail sales data (2014–2017). Built a Python data pipeline, performed exploratory data analysis, and delivered executive-facing dashboards in Tableau — identifying critical profitability gaps and actionable business recommendations.

---

## Live Dashboard

**Tableau Public:** [View Executive Dashboard](https://public.tableau.com/views/SuperstoreExecutiveBIDashboard/ExecutiveDashboard?:language=en-US&publish=yes&:sid=&:redirect=auth&:display_count=n&:origin=viz_share_link)

---

## Key Findings

- **Revenue grew 51% from 2014–2017** ($484K → $733K) but overall profit margin plateaued at ~13%, signaling a scaling efficiency problem
...
3. **Invest in the West and Technology** — highest margin combination in the dataset. Reallocating marketing budget toward this segment would improve overall profitability without requiring revenue growth
...
| Annual Revenue Growth | Year-over-year bar chart with average reference line |
...
| Tableau Public | Executive dashboard and publication |
